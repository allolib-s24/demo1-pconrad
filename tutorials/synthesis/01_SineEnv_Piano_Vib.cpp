...
class SineEnv : public SynthVoice {
 public:
  ...
  void init() override {
    ...
    createInternalTriggerParameter("vibFreq", 100.0, 0.0, 200.0);
  }
  ...
  void onProcess(AudioIOData& io) override {
    ...
    // std::cout << "vibMult=" << vibMult << " ";
    // std::cout << "vibDepth=" << vibDepth << std::endl;
    // std::cout << "scaledVibDepth=" << scaledVibDepth << std::endl;
    // std::cout << "mVib()=" << mVib() << std::endl;
    
    // mOsc.freq(getInternalParameterValue("frequency") * vibMult);
